            ...
            <div class="card bg-100 shadow-none border">
                <div class="row gx-0 flex-between-center">
                    <div class="col-sm-auto d-flex align-items-center border-bottom">
                        <img class="ms-3 mx-3" src="<?php echo e(asset('img/recycle.png')); ?>" alt="" width="50" />
                        <div>
            ...
            <table id="example" class="table table-striped nowrap" style="width:100%">
                ...
                <tbody class="fs--2">
                    ...
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $datas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($no++); ?></td>
                            <td><?php echo e($datas->kd_pemusnahan); ?></td>
                            ...
                            <td>
                                ...
                                ?>
                                <?php if($nama): ?>
                                    <?php echo e($nama->wa_number_name); ?>
                            ...
                            <td>
                                ...
                                ?>
                                <?php if($nama1): ?>
                                    <?php echo e($nama1->wa_number_name); ?>

                                <?php endif; ?>
                            </td>
                            <td><?php echo e($datas->eksekusi); ?></td>
                            <td>
                                <?php if($datas->status_pemusnahan == -1): ?>
                                    <span class="badge bg-danger fs--2">Verifikasi di Tolak</span>
                                <?php elseif($datas->status_pemusnahan == 0): ?>
                                    <span class="badge bg-warning fs--2">Belum diverifikasi</span>
                                <?php elseif($datas->status_pemusnahan == 1): ?>
                                    <span class="badge bg-primary fs--2">Sudah diverifikasi</span>
                                <?php elseif($datas->status_pemusnahan == 2): ?>
                                    <span class="badge bg-danger fs--2">Verifikasi Pembatalan</span>
                                <?php elseif($datas->status_pemusnahan == 3): ?>
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop2">
                                            ...
                                            <?php elseif($datas->status_pemusnahan == 1): ?>
                                                ...
                                                <button class="dropdown-item text-danger" data-bs-toggle="modal"
                                                    ...
                                                    data-code="<?php echo e($datas->kd_pemusnahan); ?>"><span class="fas fa-redo"></span>
                                            ...
                                            <?php elseif($datas->status_pemusnahan == 2): ?>
                                                <button class="dropdown-item text-warning" data-bs-toggle="modal"
                                                    ...
                                                    data-code="<?php echo e($datas->kd_pemusnahan); ?>"><span class="fas fa-swatchbook"></span>
...
<?php $__env->startSection('base.js'); ?>
    ...
    <script>
        $(document).on("click", "#button-add-data-pemusnahan", function (e) {
            ...
            $.ajax({
                url: "<?php echo e(route('menu_pemusnahan_add')); ?>",
                type: "POST",
                cache: false,
                data: {
        ...
        $(document).on("click", "#button-find-data-barang", function (e) {
            ...
            $.ajax({
                url: "<?php echo e(route('menu_pemusnahan_find_data_barang')); ?>",
                type: "POST",
                cache: false,
                data: data,
                dataType: 'html',
        ...
        $(document).on("click", "#button-pilih-data-barang-pemusnahan", function (e) {
            ...
            $.ajax({
                url: "<?php echo e(route('menu_pemusnahan_pilih_data_barang')); ?>",
                type: "POST",
                cache: false,
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
        ...
        $(document).on("click", "#button-verifikasi-data-pemusnahan-cabang", function (e) {
            ...
            $.ajax({
                url: "<?php echo e(route('menu_pemusnahan_pilih_data_barang_verifikasi')); ?>",
                type: "POST",
                cache: false,
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
        ...
        $(document).on("click", "#button-cetak-data-pemusnahan-cabang", function (e) {
            ...
            $.ajax({
                url: "<?php echo e(route('menu_pemusnahan_pilih_data_barang_print')); ?>",
                type: "POST",
                cache: false,
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
        ...
        $(document).on("click", "#button-check-data-barang-musnah-cabang", function (e) {
            ...
            $.ajax({
                url: "<?php echo e(route('menu_pemusnahan_check_data_pemusnahan')); ?>",
                type: "POST",
                cache: false,
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
        ...
        $(document).on("click", "#button-sinkronisasi-data-pemusnahan", function (e) {
            ...
            $.ajax({
                url: "<?php echo e(route('menu_pemusnahan_pilih_data_barang_sinkronisasi')); ?>",
                type: "POST",
                cache: false,
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
        ...
        $(document).on("click", "#button-pengembalian-data-pemusnahan-cabang", function (e) {
            ...
            $.ajax({
                url: "<?php echo e(route('menu_pemusnahan_pilih_data_barang_pengembalian')); ?>",
                type: "POST",
                cache: false,
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
        ...
        $(document).on("click", "#button-verifikasi-pembatalan-pemusnahan-cabang", function (e) {
            ...
            $.ajax({
                url: "<?php echo e(route('menu_pemusnahan_pilih_data_barang_verifikasi_pembatalan')); ?>",
                type: "POST",
                cache: false,
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel\inventaris_app\resources\views/application/pemusnahan/menupemusnahan.blade.php ENDPATH**/ ?>