            ...
            <div class="card bg-100 shadow-none border">
                <div class="row gx-0 flex-between-center">
                    <div class="col-sm-auto d-flex align-items-center border-bottom">
                        <img class="ms-3 mx-3" src="<?php echo e(asset('img/app.png')); ?>" alt="" width="50" />
                        <div>
            ...
            <div class="row text-center" id="hasil-pencarian-cabang" style="cursor: pointer;">
                <div class="col-6 col-md-4 col-lg-3 col-xxl-2 mb-4" data-bs-toggle="modal" data-bs-target="#modal-aplikasi"
                    ...
                    <div class="bg-white dark__bg-1100 p-3"><a href="#">
                            <img class="img-thumbnail img-fluid rounded-circle mb-3 shadow-sm"
                                src="<?php echo e(asset('img/peminjaman.png')); ?>" alt="" width="100"></a>
                ...
                <div class="col-6 col-md-4 col-lg-3 col-xxl-2 mb-4">
                    <div class="bg-white dark__bg-1100 p-3 h-100"><a href="#"><img
                                ...
                                src="<?php echo e(asset('img/recycle.png')); ?>" alt="" width="105"></a>
                ...
                <div class="col-6 col-md-4 col-lg-3 col-xxl-2 mb-4" data-bs-toggle="modal"
                    ...
                    <div class="bg-white dark__bg-1100 p-3 h-100"><a href="#">
                            <img class="img-thumbnail img-fluid rounded-circle mb-3 shadow-sm"
                                src="<?php echo e(asset('img/maintenance.png')); ?>" alt="" width="100"></a>
...
<?php $__env->startSection('base.js'); ?>
    ...
    <script>
        $(document).on("click", "#button-peminjaman-barang", function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('aplikasi_app_peminjaman_barang')); ?>",
                type: "POST",
                cache: false,
                data: {
        ...
        $(document).on("click", "#button-tambah-data-peminjaman", function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('aplikasi_app_peminjaman_barang_add')); ?>",
                type: "POST",
                cache: false,
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
        ...
        $(document).on("click", "#button-log-maintenance", function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('aplikasi_app_maintenance_log')); ?>",
                type: "POST",
                cache: false,
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel\inventaris_app\resources\views/application/aplikasi/menuaplikasi.blade.php ENDPATH**/ ?>