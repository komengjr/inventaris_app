        ...
        <div class="card bg-100 shadow-none border">
            <div class="row gx-0 flex-between-center">
                <div class="col-sm-auto d-flex align-items-center border-bottom">
                    <img class="ms-3 mx-3" src="<?php echo e(asset('img/stock.png')); ?>" alt="" width="50" />
                    <div>
    ...
    <div class="card-body border-top p-3">
        <table id="example" class="table table-striped nowrap" style="width:100%">
            ...
            <tbody class="fs--2">
                ...
                <tr>
                    <td><?php echo e($no++); ?></td>
                    <td><?php echo e($item->kode_verif); ?></td>
                    <td><?php echo e($item->tgl_verif); ?></td>
                    <td><?php echo e($item->end_date_verif); ?></td>
                    <td>
                        <?php
                        ...
                        ->count();
                        ?>
                        <?php if($item->status_verif == 0): ?>
                        <?php echo e($item->total_barang); ?>
                        ...
                        <div class="btn-group" role="group">
                            ...
                            <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop2">
                                ...
                                <button class="dropdown-item" data-bs-toggle="modal"
                                    ...
                                    data-code="<?php echo e($item->kode_verif); ?>" data-status="0"><span
                                        class="fas fa-check-square"></span> Baik</button>
                                <button class="dropdown-item" data-bs-toggle="modal"
                                    data-bs-target="#modal-stock-lg" id="button-kondisi-data-cabang"
                                    data-code="<?php echo e($item->kode_verif); ?>" data-status="1"><span
                                        class="fas fa-exclamation-triangle"></span> Maintenance</button>
                                <button class="dropdown-item" data-bs-toggle="modal"
                                    data-bs-target="#modal-stock-lg" id="button-kondisi-data-cabang"
                                    data-code="<?php echo e($item->kode_verif); ?>" data-status="2"><span
                                        class="fas fa-trash-alt"></span> Rusak</button>
                                <div class="dropdown-divider"></div>
                                <button class="dropdown-item" data-bs-toggle="modal"
                                    data-bs-target="#modal-stock" id="button-kondisi-unvalid-data-cabang"
                                    data-code="<?php echo e($item->kode_verif); ?>"><span class="fas fa-code-branch"></span>
                                    Unvalid</button>
...
<script>
    $(document).on("click", "#button-add-stockopname", function(e) {
        ...
        $.ajax({
            url: "<?php echo e(route('menu_stock_opname_add')); ?>",
            type: "POST",
            cache: false,
            data: {
    ...
    $(document).on("click", "#button-kondisi-data-cabang", function(e) {
        ...
        $.ajax({
            url: "<?php echo e(route('menu_stock_opname_kondisi_data')); ?>",
            type: "POST",
            cache: false,
            data: {
                "_token": "<?php echo e(csrf_token()); ?>",
    ...
    $(document).on("click", "#button-kondisi-unvalid-data-cabang", function(e) {
        ...
        $.ajax({
            url: "<?php echo e(route('menu_stock_opname_kondisi_data_unvalid')); ?>",
            type: "POST",
            cache: false,
            data: {
                "_token": "<?php echo e(csrf_token()); ?>",
    ...
    $(document).on("click", "#button-remove-full-stock-opname", function(e) {
        ...
        $.ajax({
            url: "<?php echo e(route('menu_stock_opname_remove_full_data')); ?>",
            type: "POST",
            cache: false,
            data: {
                "_token": "<?php echo e(csrf_token()); ?>",
    ...
    $(document).on("click", "#button-remove-full-data-stock", function(e) {
        ...
        $.ajax({
            url: "<?php echo e(route('menu_stock_opname_proses_remove_full_data')); ?>",
            type: "POST",
            cache: false,
            data: {
                "_token": "<?php echo e(csrf_token()); ?>",
    ...
    $(document).on("click", "#button-proses-stock-opname-cabang", function(e) {
        ...
        $.ajax({
            url: "<?php echo e(route('menu_stock_opname_proses_data')); ?>",
            type: "POST",
            cache: false,
            data: {
                "_token": "<?php echo e(csrf_token()); ?>",
    ...
    $(document).on("click", "#button-stock-opname-kamera", function(e) {
        ...
        $.ajax({
            url: "<?php echo e(route('menu_stock_opname_proses_data_with_kamera')); ?>",
            type: "POST",
            cache: false,
            data: {
                "_token": "<?php echo e(csrf_token()); ?>",
    ...
    $(document).on("click", "#button-stock-opname-scanner", function(e) {
        ...
        $.ajax({
            url: "<?php echo e(route('menu_stock_opname_proses_data_with_scanner')); ?>",
            type: "POST",
            cache: false,
            data: {
                "_token": "<?php echo e(csrf_token()); ?>",
    ...
    $(document).on("click", "#button-simpan-hasil-verifikasi", function(e) {
        ...
        e.preventDefault();
        $.ajax({
                url: "<?php echo e(route('menu_stock_opname_scan_data_with_scanner_save')); ?>",
                type: "POST",
                data: data,
                dataType: "html",
            })
    ...
    //     );
    //     $.ajax({
    //         url: "<?php echo e(route('masteradmin_cabang_data_stock_opname')); ?>",
    //         type: "POST",
    //         cache: false,
    //         data: {
    //             "_token": "<?php echo e(csrf_token()); ?>",
    ...
    //     );
    //     $.ajax({
    //         url: "<?php echo e(route('masteradmin_cabang_preview_data_stock_opname')); ?>",
    //         type: "POST",
    //         cache: false,
    //         data: {
    //             "_token": "<?php echo e(csrf_token()); ?>",
    ...
    //     );
    //     $.ajax({
    //         url: "<?php echo e(route('masteradmin_cabang_migrasi_data_cabang')); ?>",
    //         type: "POST",
    //         cache: false,
    //         data: {
    //             "_token": "<?php echo e(csrf_token()); ?>",
    ...
    //     );
    //     $.ajax({
    //         url: "<?php echo e(route('masteradmin_cabang_clone_data_master_barang')); ?>",
    //         type: "POST",
    //         cache: false,
    //         data: {
    //             "_token": "<?php echo e(csrf_token()); ?>",
    ...
    $(document).on("click", "#button-print-stockopname-ruangan", function(e) {
        ...
        $.ajax({
            url: "<?php echo e(route('menu_stock_opname_print_data_ruangan')); ?>",
            type: "POST",
            cache: false,
            data: {
                "_token": "<?php echo e(csrf_token()); ?>",
    ...
    $(document).on("click", "#button-edit-data-stock-opname", function(e) {
        ...
        $.ajax({
            url: "<?php echo e(route('menu_stock_opname_edit_data_tanggal')); ?>",
            type: "POST",
            cache: false,
            data: {
                "_token": "<?php echo e(csrf_token()); ?>",
    ...
    $(document).on("click", "#button-data-sinkronisasi-stock-cabang", function(e) {
        ...
        $.ajax({
            url: "<?php echo e(route('menu_stock_opname_sinkronisasi_data_stock')); ?>",
            type: "POST",
            cache: false,
            data: {
                "_token": "<?php echo e(csrf_token()); ?>",
    ...
    $(document).on("click", "#button-penyelesaian-stockopname", function(e) {
        ...
        $.ajax({
            url: "<?php echo e(route('menu_stock_opname_penyelesaian_data')); ?>",
            type: "POST",
            cache: false,
            data: {
                "_token": "<?php echo e(csrf_token()); ?>",
    ...
    $(document).on("click", "#button-print-stock-opname-cabang", function(e) {
        ...
        $.ajax({
            url: "<?php echo e(route('menu_stock_opname_laporan_data')); ?>",
            type: "POST",
            cache: false,
            data: {
                "_token": "<?php echo e(csrf_token()); ?>",
    ...
    $(document).on("click", "#button-fix-data-stockopname", function(e) {
        ...
        $.ajax({
            url: "<?php echo e(route('divisi/postverifikasiall/datasemua/fixdata')); ?>",
            headers: {
...
<script>
    $(document).on("click", "#button-stock-opname-manual", function(e) {
        ...
        $.ajax({
            url: "<?php echo e(route('menu_stock_opname_proses_data_with_checklist')); ?>",
            type: "POST",
            cache: false,
            data: {
                "_token": "<?php echo e(csrf_token()); ?>",
    ...
    $(document).on("click", "#button-stockopname-ba-template", function(e) {
        ...
        $.ajax({
            url: "<?php echo e(route('menu_stock_opname_print_berita_acara_2')); ?>",
            type: "POST",
            cache: false,
            data: {
                "_token": "<?php echo e(csrf_token()); ?>",
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel\inventaris_app\resources\views/application/stockopname/menu-stock-opname.blade.php ENDPATH**/ ?>