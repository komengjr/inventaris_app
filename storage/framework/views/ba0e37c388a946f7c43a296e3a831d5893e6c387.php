        ...
        <div class="card-body">
            <div class="row flex-between-center">
                <div class="col-sm-auto mb-2 mb-sm-0">
                    <h6 class="mb-0">Totoal Cabang : <?php echo e($data->count()); ?></h6>
                </div>
                    ...
                    <div class="mb-4 col-md-6 col-lg-4 ">
                        <div class="border border-primary rounded-1 h-100 d-flex flex-column justify-content-between pb-3">
                            <div class="overflow-hidden">
                                ...
                                <div class="p-3">
                                    <h5 class="fs-0">
                                        <a class="text-dark" href="#l"><?php echo e($datas->nama_cabang); ?></a>
                                    </h5>
                                    <p class="fs--1 mb-1">
                                        <a class="text-500" href="#!"><?php echo e($datas->alamat); ?></a>
                                    </p>
                                </div>
                            </div>
                            <div class="d-flex flex-between-center px-3">
                                <div>
                                    <p class="fs--1 mb-1">
                                        Phone : <strong><?php echo e($datas->phone); ?></strong>
                                    </p>
                                    <p class="fs--1 mb-1">
                                        Entitas : <strong class="text-success"><?php echo e($datas->nama_entitas_cabang); ?></strong>
                                    </p>
                                </div>
                                <div>
                                    <div class="btn-group" role="group">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop2">
                                            <button class="dropdown-item" data-bs-toggle="modal"
                                                ...
                                                data-code="<?php echo e($datas->kd_cabang); ?>"><span class="fas fa-swatchbook"></span>
                                                Data Barang Cabang</button>
                                            <button class="dropdown-item" data-bs-toggle="modal"
                                                data-bs-target="#modal-menu-cabang" id="button-data-peminjaman-cabang"
                                                data-code="<?php echo e($datas->kd_cabang); ?>"><span
...
<?php $__env->startSection('base.js'); ?>
    ...
    <script>
        $(document).on("click", "#button-cari-data-nama-cabang", function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('menu_cabang_find_cabang')); ?>",
                type: "POST",
                cache: false,
                data: {
        ...
        $(document).on("click", "#button-data-barang-cabang", function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('menu_cabang_data_barang')); ?>",
                type: "POST",
                cache: false,
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
        ...
        $(document).on("click", "#button-data-peminjaman-cabang", function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('menu_cabang_data_peminjaman')); ?>",
                type: "POST",
                cache: false,
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
        ...
        $(document).on("click", "#button-data-mutasi-cabang", function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('menu_cabang_data_mutasi')); ?>",
                type: "POST",
                cache: false,
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
        ...
        $(document).on("click", "#button-data-srockopname-cabang", function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('menu_cabang_data_stockopname')); ?>",
                type: "POST",
                cache: false,
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
    ...
    <script>
        $(document).on("click", "#button-report-peminjaman-cabang", function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('menu_cabang_data_peminjaman_print')); ?>",
                type: "POST",
                cache: false,
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
        ...
        $(document).on("click", "#button-report-mutasi-cabang", function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('menu_cabang_data_mutasi_print')); ?>",
                type: "POST",
                cache: false,
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
        ...
        $(document).on("click", "#button-report-stockopname-cabang", function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('menu_cabang_data_stockopname_print')); ?>",
                type: "POST",
                cache: false,
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel\inventaris_app\resources\views/application/menu-cabang/menu-cabang.blade.php ENDPATH**/ ?>