...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo e(asset('img/header.png')); ?>">
    <!-- Bootstrap 5 -->
...
<body>
    ...
    <div class="login-card">
        <div class="text-center mb-2">
            <img src="<?php echo e(asset('vendor/new-anim.gif')); ?>" alt="" width="400" style="width: 100%; height: auto;">
    ...
    <script>
        ...
        form.addEventListener('submit', function (e) {
            ...
            btn.disabled = true;
            $.ajax({
                url: "<?php echo e(route('verifikasi_Login')); ?>",
                type: "POST",
                cache: false,
                data: {
...
<?php /**PATH C:\laravel\inventaris_app\resources\views/auth/login.blade.php ENDPATH**/ ?>