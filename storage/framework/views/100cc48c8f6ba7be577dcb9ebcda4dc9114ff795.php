...
<head>
    ...
    <!--    Favicons-->
    <!-- ===============================================-->
    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo e(asset('img/pram.png')); ?>">
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo e(asset('img/pram.png')); ?>">
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo e(asset('img/pram.png')); ?>">
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(asset('img/pram.png')); ?>">
    <link rel="manifest" href="<?php echo e(asset('asset/img/favicons/manifest.json')); ?>">
    <meta name="msapplication-TileImage" content="<?php echo e(asset('img/pram.png')); ?>">
    <meta name="theme-color" content="#ffffff">
    <script src="<?php echo e(asset('asset/js/config.js')); ?>"></script>
    ...
    <link href="<?php echo e(asset('asset/css/theme-rtl.min.css')); ?>" rel="stylesheet" id="style-rtl">
    <link href="<?php echo e(asset('asset/css/theme.min.css')); ?>" rel="stylesheet" id="style-default">
    <link href="<?php echo e(asset('asset/css/user-rtl.min.css')); ?>" rel="stylesheet" id="user-style-rtl">
    <link href="<?php echo e(asset('asset/css/user.min.css')); ?>" rel="stylesheet" id="user-style-default">

    <?php echo $__env->yieldContent('base.css'); ?>
...
<body>
                ...
                <div class="d-flex align-items-center">
                    <div class="toggle-icon-wrapper">
                        ...
                        <div class="d-flex align-items-center py-3"><img class="me-2"
                                src="<?php echo e(asset('img/pram.png')); ?>" alt=""
                        ...
                        <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                            ...
                            <li class="nav-item">
                                ...
                                <div class="row navbar-vertical-label-wrapper mt-3 mb-2">
                                    <div class="col-auto navbar-vertical-label"><?php echo e($menus->menu_name); ?>
                                ...
                                ->get();
                                ?>
                                <?php $__currentLoopData = $sub_menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub_menus): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a class="nav-link"
                                    href="<?php echo e(url($sub_menus->menu_sub_code . '/' . $sub_menus->menu_sub_link)); ?>"
                                    role="button" aria-expanded="false">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                class="<?php echo e($sub_menus->menu_sub_icon); ?>"></span></span><span
                                            class="nav-link-text ps-1"><?php echo e($sub_menus->menu_sub_name); ?></span>
                                    </div>
                                </a>
                            ...
                            <li class="nav-item">
                                ...
                                <!-- parent pages--><a class="nav-link" href="<?php echo e(route('masteradmin_user')); ?>"
                                    role="button" aria-expanded="false">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                ...
                                <!-- parent pages--><a class="nav-link" href="<?php echo e(route('masteradmin_lokasi')); ?>"
                                    role="button" aria-expanded="false">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                ...
                                <!-- parent pages--><a class="nav-link"
                                    href="<?php echo e(route('masteradmin_category')); ?>" role="button"
                                    aria-expanded="false">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                ...
                                <!-- parent pages--><a class="nav-link"
                                    href="<?php echo e(route('masteradmin_klasifikasi')); ?>" role="button"
                                    aria-expanded="false">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                ...
                                <!-- parent pages--><a class="nav-link" href="<?php echo e(route('masteradmin_cabang')); ?>"
                                    role="button" aria-expanded="false">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                ...
                                <!-- parent pages--><a class="nav-link" href="<?php echo e(route('masteradmin_depresiasi')); ?>"
                                    role="button" aria-expanded="false">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                ...
                                <!-- parent pages--><a class="nav-link" href="<?php echo e(route('masteradmin_messages')); ?>"
                                    role="button" aria-expanded="false">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                ...
                                <!-- parent pages--><a class="nav-link" href="<?php echo e(route('masteradmin_menu')); ?>"
                                    role="button" aria-expanded="false">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                class="far fa-newspaper"></span></span><span
                                ...
                                <!-- parent pages--><a class="nav-link" href="<?php echo e(route('masteradmin_access')); ?>"
                                    role="button" aria-expanded="false">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                ...
                                <!-- parent pages--><a class="nav-link" href="<?php echo e(route('master_setting')); ?>"
                                    role="button" aria-expanded="false">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                ...
                                <!-- parent pages--><a class="nav-link" href="<?php echo e(route('masteradmin_maps')); ?>"
                                    role="button" aria-expanded="false">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                class="fas fa-cog"></span></span><span
            ...
            <div class="content">
                    ...
                    <ul class="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
                        ...
                        <li class="nav-item dropdown"><a class="nav-link pe-0" id="navbarDropdownUser"
                                ...
                                <div class="avatar avatar-xl">
                                    <img class="rounded-circle" src="<?php echo e(asset('asset/img/team/avatar.png')); ?>"
                                        alt="" />
                            ...
                            <div class="dropdown-menu dropdown-menu-end py-0" aria-labelledby="navbarDropdownUser">
                                <div class="bg-white dark__bg-1000 rounded-2 py-2">
                                    ...
                                    <a class="dropdown-item text-primary text-center"><?php echo e(Auth::user()->name); ?></a>
                ...
                <footer class="footer">
                    <div class="row g-0 justify-content-between fs--1 mt-4 mb-3">
                        ...
                        <div class="col-12 col-sm-auto text-center">
                            <img src="<?php echo e(asset('img/pram.png')); ?>" alt="" width="80">
                        </div>
                    </div>
                </footer>
            </div>
        ...
        <div class="offcanvas-body scrollbar-overlay px-card" id="themeController">
                ...
                <div class="row gx-2">
                    <div class="col-6">
                        ...
                        <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherLight"> <span
                                class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                    src="<?php echo e(asset('asset/img/generic/falcon-mode-default.jpg')); ?>"
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherDark"> <span
                                class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                    src="<?php echo e(asset('asset/img/generic/falcon-mode-dark.jpg')); ?>"
            ...
            <div class="d-flex justify-content-between">
                <div class="d-flex align-items-start"><img class="me-2"
                        src="<?php echo e(asset('asset/img/icons/left-arrow-from-left.svg')); ?>" width="20"
                        alt="" />
                    <div class="flex-1">
            ...
            <div class="d-flex justify-content-between">
                <div class="d-flex align-items-start"><img class="me-2"
                        src="<?php echo e(asset('asset/img/icons/arrows-h.svg')); ?>" width="20" alt="" />
                    <div class="flex-1">
                ...
                <div class="row gx-2">
                    <div class="col-6">
                        ...
                        <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-transparent"> <img
                                class="img-fluid img-prototype" src="<?php echo e(asset('asset/img/generic/default.png')); ?>"
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-inverted"> <img
                                class="img-fluid img-prototype" src="<?php echo e(asset('asset/img/generic/inverted.png')); ?>"
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-card"> <img
                                class="img-fluid img-prototype" src="<?php echo e(asset('asset/img/generic/card.png')); ?>"
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-vibrant"> <img
                                class="img-fluid img-prototype" src="<?php echo e(asset('asset/img/generic/vibrant.png')); ?>"
    ...
    <script src="<?php echo e(asset('online/resumable.min.js')); ?>"></script>
    <?php echo $__env->yieldContent('base.js'); ?>
    ...
    <script>
        $(document).on("click", "#button-setup-profil", function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('dashboard_setup_profile')); ?>",
                type: "POST",
                cache: false,
                data: {
        ...
        $(document).on("click", "#button-setup-notification", function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('dashboard_setup_notification')); ?>",
                type: "POST",
                cache: false,
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
...
<?php /**PATH C:\laravel\inventaris_app\resources\views/layouts/template.blade.php ENDPATH**/ ?>