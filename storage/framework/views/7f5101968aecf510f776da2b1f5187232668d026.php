            ...
            <div class="card bg-100 shadow-none border">
                <div class="row gx-0 flex-between-center">
                    <div class="col-sm-auto d-flex align-items-center border-bottom">
                        <img class="ms-3 mx-3" src="<?php echo e(asset('img/mutasi.png')); ?>" alt="" width="50" />
                        <div>
                ...
                <tbody class="fs--2">
                    ...
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($item->kd_mutasi); ?></td>
                            <td>
                                <?php echo e($cabang->nama_cabang); ?><br>
                            ...
                            <td>
                                ...
                                <?php else: ?>
                                    <?php echo e($item->penanggung_jawab); ?>

                                <?php endif; ?>
                            </td>
                            <td>
                                <?php echo e($item->menyetujui); ?>

                            </td>
                            <td>
                                <?php echo e($item->yang_menyerahkan); ?>
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop2">
                                        <?php if($item->status_mutasi == 0): ?>
                                            <button class="dropdown-item text-primary" data-bs-toggle="modal"
                                                ...
                                                data-code="<?php echo e($item->kd_mutasi); ?>"><span
                                            ...
                                            <button class="dropdown-item text-danger" data-bs-toggle="modal"
                                                ...
                                                data-code="<?php echo e($item->kd_mutasi); ?>"><span class="fas fa-trash"></span>
                                                Hapus Data Mutasi</button>
                                        <?php elseif($item->status_mutasi == 1): ?>
...
<?php $__env->startSection('base.js'); ?>
    ...
    <script>
        $(document).on("click", "#button-add-data-mutasi-cabang", function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('menu_mutasi_add')); ?>",
                type: "POST",
                cache: false,
                data: {
        ...
        $(document).on("click", "#button-remove-barang-mutasi", function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('menu_mutasi_remove_data_barang')); ?>",
                type: "POST",
                cache: false,
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
        ...
        $(document).on("click", "#button-show-order-mutasi-cabang", function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('menu_mutasi_show_data_order_mutasi')); ?>",
                type: "POST",
                cache: false,
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
        ...
        $(document).on("click", "#button-rekap-order-mutasi-cabang", function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('menu_mutasi_rekap_data_order_mutasi')); ?>",
                type: "POST",
                cache: false,
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
        ...
        $(document).on("click", "#button-terima-order-mutasi", function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('menu_mutasi_terima_data_order_mutasi')); ?>",
                type: "POST",
                cache: false,
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
        ...
        $(document).on("click", "#button-pilih-lokasi-barang-mutasi", function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('menu_mutasi_pilih_lokasi_data_order_mutasi')); ?>",
                type: "POST",
                cache: false,
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
        ...
        $(document).on("click", "#button-form-pilih-lokasi-barang", function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('menu_mutasi_proses_lokasi_data_order_mutasi')); ?>",
                type: "POST",
                cache: false,
                data: data,
                dataType: 'html',
        ...
        $(document).on("click", "#button-poroses-terima-verifikasi-data-mutasi", function(e) {
            ...
            if (penerima == '') {
                ...
                $.ajax({
                    url: "<?php echo e(route('menu_mutasi_proses_terima_lokasi_data_order_mutasi')); ?>",
                    type: "POST",
                    cache: false,
                    data: {
                        "_token": "<?php echo e(csrf_token()); ?>",
        ...
        $(document).on("click", "#button-input-data-barang-mutasi", function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('menu_mutasi_add_barang')); ?>",
                type: "POST",
                cache: false,
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
        ...
        $(document).on("click", "#button-remove-data-mutasi", function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('menu_mutasi_remove_mutasi')); ?>",
                type: "POST",
                cache: false,
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
        ...
        $(document).on("click", "#button-pilih-barang-mutasi", function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('menu_mutasi_pilih_data')); ?>",
                type: "POST",
                cache: false,
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
        ...
        $(document).on("click", "#button-verifikasi-data-mutasi", function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('menu_mutasi_verifikasi_data_mutasi')); ?>",
                type: "POST",
                cache: false,
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
        ...
        $(document).on("click", "#button-verifikasi-code-data-mutasi", function(e) {
            ...
            if (verifikasi_code == '') {
                ...
                $.ajax({
                    url: "<?php echo e(route('menu_mutasi_verifikasi_code_data_mutasi')); ?>",
                    type: "POST",
                    cache: false,
                    data: {
                        "_token": "<?php echo e(csrf_token()); ?>",
        ...
        $(document).on("click", "#button-proses-verifikasi-data-mutasi-cabang", function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('menu_mutasi_proses_verifikasi_data_mutasi')); ?>",
                type: "POST",
                cache: false,
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
        ...
        $(document).on("click", "#button-print-data-mutasi-cabang", function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('menu_mutasi_print_data_mutasi')); ?>",
                type: "POST",
                cache: false,
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
    ...
    <script>
        $(document).on("click", "#button-print-rekap-order-mutasi", function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('menu_mutasi_proses_print_data_mutasi')); ?>",
                type: "POST",
                cache: false,
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel\inventaris_app\resources\views/application/mutasi/menumutasi.blade.php ENDPATH**/ ?>