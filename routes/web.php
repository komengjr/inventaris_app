...
Route::prefix('masteradmin')->group(function () {
    ...
    Route::post('cabang/add', [MasterAdminController::class, 'masteradmin_cabang_add'])->name('masteradmin_cabang_add');
    Route::post('cabang/save', [MasterAdminController::class, 'masteradmin_cabang_save'])->name('masteradmin_cabang_save');
    Route::post('cabang/edit', [MasterAdminController::class, 'masteradmin_cabang_edit'])->name('masteradmin_cabang_edit');
    Route::post('cabang/edit-save', [MasterAdminController::class, 'masteradmin_cabang_edit_save'])->name('masteradmin_cabang_edit_save');
    ...
    Route::post('cabang/delete-multiple-barang', [MasterAdminController::class, 'masteradmin_cabang_delete_multiple_barang'])->name('masteradmin_cabang_delete_multiple_barang');
    ...
    Route::post('cabang/data-peminjaman-cabang/sinkronisasi', [MasterAdminController::class, 'masteradmin_cabang_data_peminjaman_sinkronisas'])->name('masteradmin_cabang_data_peminjaman_sinkronisas');
    ...
    Route::get('masteradmin_messages_json', [MasterAdminController::class, 'masteradmin_messages_json'])->name('masteradmin_messages_json');
