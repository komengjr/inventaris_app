        ...
        <div class="card bg-100 shadow-none border border-primary">
            <div class="row gx-0 flex-between-center">
                <div class="col-sm-auto d-flex align-items-center border-bottom">
                    <img class="ms-3 mx-3 m-2" src="{{ asset('img/home.png') }}" alt="" width="50" />
                    <div>
                        <h6 class="text-primary fs--1 mb-0 mt-2">Welcome to {{ $cabang->nama_cabang }}</h6>
                        <h4 class="text-primary fw-bold mb-1">Inventaris <span class="text-info fw-medium">Management System</span></h4>
                    </div>
                    ...
                    <div class="col-lg-4 border-lg-end border-bottom border-lg-0 py-3 py-lg-2">
                        <div class="d-flex flex-between-center mb-1">
                            ...
                            <div class="dropdown font-sans-serif btn-reveal-trigger">
                                <button class="btn btn-falcon-primary text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal" type="button" id="dropdown-new-users" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h fs--2"></span></button>
                                <div class="dropdown-menu dropdown-menu-end border py-2" aria-labelledby="dropdown-new-users">
                                    <a class="dropdown-item" href="#!" data-bs-toggle="modal" data-bs-target="#modal-dashboard" id="button-add-barang-non-aset">Tambah Barang Non Aset</a>
                                    <a class="dropdown-item" href="#!" data-bs-toggle="modal" data-bs-target="#modal-dashboard" id="button-data-barang-non-aset">View Barang Non Aset</a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item text-primary" href="#!" data-bs-toggle="modal" data-bs-target="#modal-dashboard-lg" id="button-export-data-non-aset"><span class="fas fa-file-export"></span> Export Data Non Aset</a>
                                </div>
                            </div>
                        </div>
                        <div class="d-flex flex-between-center mb-1">
                            <div class="d-flex align-items-center">
                                <div class="icon-item icon-item-sm bg-soft-warning shadow-none me-2 bg-soft-info"><span class="fs--2 fas fa-shipping-fast text-info"></span></div>
                                <h5 class="mb-0" style="font-family: 'Courier New';">{{ $datanonaset }} Barang</h5>
                            </div>
                        </div>
                        <div class="d-flex flex-between-center mb-1">
                            <div class="d-flex align-items-center">
                                <div class="icon-item icon-item-sm bg-soft-primary shadow-none me-2 bg-soft-info"><span class="fs--2 fas fa-money-check-alt text-info"></span></div>
                    ...
                    <div class="col-lg-4 border-lg-end border-bottom border-lg-0 py-3 py-lg-2">
                        <div class="d-flex flex-between-center mb-1">
                            ...
                            <div class="dropdown font-sans-serif btn-reveal-trigger">
                                <button class="btn btn-falcon-primary text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal" type="button" id="dropdown-new-users" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h fs--2"></span></button>
                                <div class="dropdown-menu dropdown-menu-end border py-2" aria-labelledby="dropdown-new-users">
                                    <a class="dropdown-item" href="#!" data-bs-toggle="modal" data-bs-target="#modal-dashboard" id="button-add-barang-aset">Tambah Barang Aset</a>
                                    <a class="dropdown-item" href="#!" data-bs-toggle="modal" data-bs-target="#modal-dashboard" id="button-data-barang-aset">View Barang Aset</a>
                                    <a class="dropdown-item" href="#!" data-bs-toggle="modal" data-bs-target="#modal-dashboard" id="button-data-doc-depresiasi">Data Depresiasi</a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item text-primary" data-bs-toggle="modal" data-bs-target="#modal-dashboard-lg" href="#!" id="button-export-data-aset"><span class="fas fa-file-export"></span> Export Data Aset</a>
                                </div>
                            </div>
                        </div>
                        <div class="d-flex flex-between-center mb-1">
                            <div class="d-flex align-items-center">
                                <div class="icon-item icon-item-sm bg-soft-warning shadow-none me-2 bg-soft-info"><span class="fs--1 fab fa-wpforms text-info"></span></div>
                    ...
                    <div class="col-lg-4 border-lg-0 py-3 py-lg-2">
                        <div class="d-flex flex-between-center mb-1">
                            ...
                            <div class="dropdown font-sans-serif btn-reveal-trigger">
                                <button class="btn btn-falcon-primary text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal" type="button" id="dropdown-new-users" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h fs--2"></span></button>
                                <div class="dropdown-menu dropdown-menu-end border py-2" aria-labelledby="dropdown-new-users">
                                    <a class="dropdown-item" href="#!" data-bs-toggle="modal" data-bs-target="#modal-dashboard" id="button-add-barang-kso">Tambah Barang KSO</a>
                                    <a class="dropdown-item" href="#!" data-bs-toggle="modal" data-bs-target="#modal-dashboard" id="button-data-barang-kso">View Data KSO</a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item text-primary" href="#!"><span class="fas fa-file-export"></span> Export Data KSO</a>
                                </div>
                            </div>
                        </div>
                        <div class="d-flex flex-between-center mb-1">
                            <div class="d-flex align-items-center">
                                <div class="icon-item icon-item-sm bg-soft-warning shadow-none me-2 bg-soft-info"><span class="fs--2 far fa-folder text-info"></span></div>
                                <h6 class="mb-0">{{ $datakso }} Barang</h6>
                            </div>
                        </div>
                        <div class="d-flex flex-between-center mb-1">
                            <div class="d-flex align-items-center">
                                <div class="icon-item icon-item-sm bg-soft-primary shadow-none me-2 bg-soft-info"><span class="fs--2 fas fa-book text-info"></span></div>
        ...
        <div class="card">
            <div class="card-header d-flex flex-between-center py-2 border-bottom">
                ...
                <div class="dropdown font-sans-serif btn-reveal-trigger">
                    ...
                    <div class="dropdown-menu dropdown-menu-end border py-2" aria-labelledby="dropdown-most-leads"></div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-7">
                        <div class="table-responsive scrollbar pt-2">
                            <table class="table table-hover table-striped border" border="1" style="border-radius: 2%;">
                                <tbody>
                                    @foreach ($klasifikasi as $klasifikasis)
                                    <tr class="align-middle fs--2 my-0" style="cursor: pointer;" id="button-show-barang-klasifikasi" data-bs-toggle="modal" data-bs-target="#modal-dashboard" data-code="{{ $klasifikasis->inventaris_cat_code }}">
                                        <td class="text-nowrap">
                                            <div class="d-flex align-items-center">
                                                <div class="avatar avatar-xl">
                                                    <img class="rounded-circle" src="{{ asset('img/peminjaman.png') }}" alt="" />
                                                </div>
                                                <div class="ms-2">{{ $klasifikasis->inventaris_cat_name }}</div>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="badge rounded-pill d-block badge-soft-success">{{ $klasifikasis->total_barang ?? 0 }}</span>
                                        </td>
                                        <td class="text-end">@currency($klasifikasis->total_harga ?? 0)</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
...
<div class="card">
    ...
    <div class="card-body bg-light px-1 py-0">
        <div class="row g-0 text-center fs--1" id="menu-pencarian-ruangan">
            @foreach ($ruangan as $ruangans)
            <div class="col-6 col-md-3 col-lg-2 mb-1">
                <div class="card-body border h-100 " id="button-view-data-lokasi" data-code="{{ $ruangans->id_nomor_ruangan_cbaang }}" data-bs-toggle="modal" data-bs-target="#modal-dashboard">
                    <div class="bg-white dark__bg-1100 border p-3 h-100 border-primary">
                        <a href="#"><img class="img-thumbnail img-fluid rounded-circle mb-3 shadow-sm" src="{{ asset('ruangan.png') }}" alt="" width="100" /></a>
                        <h6 class="mb-1"><a href="#">{{ $ruangans->master_lokasi_name }}</a></h6>
                        <p class="fs--2 mb-0">Nomor Ruangan : <span class="badge bg-primary m-1">{{ $ruangans->nomor_ruangan }}</span></p>
                        <p class="fs--2 mb-0">Total Barang : {{ $ruangans->total_barang ?? 0 }}</p>
                    </div>
                </div>
            </div>
            @endforeach
...
@section('base.js')
<div class="modal fade" id="modal-dashboard" data-bs-keyboard="false" data-bs-backdrop="static" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="false">
...
<div class="modal fade" id="modal-dashboard-lg" data-bs-keyboard="false" data-bs-backdrop="static" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="false">
...
<script>
    $(document).on("click", "#button-add-barang-non-aset", function(e) {
        e.preventDefault();
        $('#menu-dashboard').html('<div class="spinner-border my-3" style="display: block; margin-left: auto; margin-right: auto;" role="status"><span class="visually-hidden">Loading...</span></div>');
        $.ajax({
    ...
    $(document).on("click", "#button-export-data-non-aset", function(e) {
        e.preventDefault();
        $('#menu-dashboard-lg').html('<div class="spinner-border my-3" style="display: block; margin-left: auto; margin-right: auto;" role="status"><span class="visually-hidden">Loading...</span></div>');
        $.ajax({
    ...
    $(document).on("click", "#button-print-barcode-page", function(e) {
        ...
        if (page == "-") {
            ...
            $("#menu-data-lokasi-barang").html('<div style="text-align: center; padding:2%;"><div class="spinner-border" role="status" > <span class="sr-only">Loading...</span> </div></div>');
            $.ajax({
                ...
                $("#menu-data-lokasi-barang").html('<iframe src="data:application/pdf;base64, ' + data + '" style="width:100%; height:500px;" frameborder="0"></iframe>');
            }).fail(function() {
                alert('error');
            });
        }
    ...
    $(document).on("click", "#button-metode-export-data", function(e) {
        ...
        $("#menu-data-export-barang-non-aset").html('<div style="text-align: center; padding:2%;"><div class="spinner-border" role="status" > <span class="sr-only">Loading...</span> </div></div>');
        if (option == "-") {
            alert('eror');
        } else if (option == "data") {
            $.ajax({
            ...
            $.ajax({
                ...
                $("#menu-data-export-barang-non-aset").html('<iframe src="data:application/pdf;base64, ' + data + '" style="width:100%; height:500px;" frameborder="0"></iframe>');
            }).fail(function() {
                alert('error');
            });
        }
    ...
    $(document).on("click", "#button-metode-export-data-aset", function(e) {
        ...
        var id = $(this).data("id");
        var option = document.getElementById("option").value;
        $("#menu-data-export-barang-non-aset").html('<div style="text-align: center; padding:2%;"><div class="spinner-border spinner-sm" role="status" > <span class="sr-only">Loading...</span> </div></div>');
        if (option == "-") {
            alert('eror');
        } else if (option == "data") {
            $.ajax({
    ...
    $(document).on("click", "#button-document-data-kso", function(e) {
        e.preventDefault();
        var code = $(this).data("code");
        $('#menu-data-barang-kso').html('<div class="spinner-border my-3" style="display: block; margin-left: auto; margin-right: auto;" role="status"><span class="visually-hidden">Loading...</span></div>');
        $.ajax({
    ...
    $(document).on("click", "#button-update-data-barang-lokasi", function(e) {
        e.preventDefault();
        var code = $(this).data("code");
        $('#menu-data-barang-lokasi').html('<div class="spinner-border my-3" style="display: block; margin-left: auto; margin-right: auto;" role="status"><span class="visually-hidden">Loading...</span></div>');
        $.ajax({
    ...
    $(document).on("click", "#button-simpan-update-data-inventaris", function(e) {
        ...
        $('#menu-simpan-data-inventaris').html('<div class="spinner-border my-3" style="display: block; margin-left: auto; margin-right: auto;" role="status"><span class="visually-hidden">Loading...</span></div>');

        if (nama == "" || klasifikasi == "" || tgl_beli == "" || harga_perolehan == "" || lokasi == "") {
            alert('eror');
            $('#menu-simpan-data-inventaris').html('<button type="submit" class="btn btn-outline-success" id="button-simpan-data-non-aset"><i class="fa fa-save"></i> Simpan Data</button>');
        } else {
            $.ajax({
...
<script>
    const searchInput = document.getElementById('cariruangan');
    searchInput.addEventListener('input', function() {
        const code = this.value.toLowerCase().trim();
        $.ajax({
            url: "{{ route('dashboard_update_data_inventaris_pencarian') }}",
            type: "POST",
            cache: false,
            data: {
                "_token": "{{ csrf_token() }}",
            ...
            $("#menu-pencarian-ruangan").html(data);
        }).fail(function() {
            $("#menu-pencarian-ruangan").html('<i class="fa fa-info-sign"></i> Something went wrong, Please try again...');
        });
    });
</script>
            ...
            var getDefaultOptions = function getDefaultOptions() {
                return {
                    ...
                    series: [{
                        ...
                        data: [
                            @foreach($klasifikasi as $klasifikasis) {
                                value: "{{ $klasifikasis->total_barang ?? 0 }}",
