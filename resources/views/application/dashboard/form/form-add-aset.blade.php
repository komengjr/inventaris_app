    ...
    <div class="bg-primary text-white rounded-top-lg py-3 px-4 d-flex justify-content-between align-items-center">
        <div>
            <h4 class="mb-0 text-white fw-bold" id="staticBackdropLabel">
                <i class="fas fa-boxes-stacked me-2"></i>Form Penambahan Barang Aset
            </h4>
            <p class="fs--2 mb-0 text-white-50">Lengkapi detail informasi barang aset di bawah ini</p>
        </div>
        <!-- <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button> -->
    </div>

    <form method="POST" action="#" enctype="multipart/form-data" id="form-add-data-aset" class="p-4">
        @csrf
                ...
                <div class="col-lg-4 border-end-lg">
                    ...
                    <div class="preview-img-container mb-3 bg-light d-flex align-items-center justify-content-center">
                        <a href="{{ asset('no_img.jpg') }}" data-fancybox="images" id="fancyboxLink">
                            <img src="{{ asset('no_img.jpg') }}" alt="Preview Barang Aset" class="img-fluid" id="videoPreview">
                        </a>
                    </div>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-12">
                            <div class="form-floating">
                                ...
                                <label for="nama_barang">Nama Barang Aset <span class="text-danger">*</span></label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select form-select-lg kategori_barang" name="jenis" id="jenis" required>
                                <option value="1" selected>Barang Aset</option>
                            </select>
                        </div>
                    </div>
        ...
        <div class="modal-footer border-top mt-4 px-0 pb-0 pt-3">
            ...
            <div id="menu-simpan-data-aset">
                <button type="submit" class="btn btn-primary px-4" id="button-simpan-data-aset">
