                        ...
                        <div class="col-sm-auto">
                            <div class="btn-group" role="group">
                                ...
                                <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop2">
                                    <button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#modal-klasifikasi"
                                        id="button-add-data-klasifikasi-v2"><span class="far fa-edit"></span>
                            ...
                            <tbody class="">
                                ...
                                @foreach ($data_v2 as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->nama_klasifikasi_barang }}</td>
                                        <td><button class="btn btn-falcon-warning btn-sm"><i
                            ...
                            <tbody>
                                ...
                                @foreach ($data_v3 as $items)
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-falcon-warning btn-sm"><i
...
@endsection
@section('base.js')
    <div class="modal fade" id="modal-klasifikasi" data-bs-keyboard="false" data-bs-backdrop="static" tabindex="-1"
