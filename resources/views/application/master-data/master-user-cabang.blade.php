        ...
        <div class="card bg-100 shadow-none border">
            <div class="row gx-0 flex-between-center">
                ...
                <div class="col-xl-auto px-3 py-2">
                    ...
                    <h4 class="text-primary fw-bold mb-0">Master <span class="text-info fw-medium">User Cabang</span>
                    </h4>
                </div>
            </div>
        </div>
...
<div class="card mb-3">
    <div class="card-header">
        <div class="row align-items-center">
            <div class="col">
                <h5 class="mb-0">Master User Cabang</h5>
            </div>
            <div class="col-auto">
                <div class="btn-group" role="group">
                    ...
                    <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop2">
                        ...
                        <button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#modal-staff-lg"
                            id="button-add-user-cabang"><span class="fas fa-user-lock"></span>
                        ...
                        <div class="btn-group" role="group">
                            ...
                            <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop2">
                                <button class="dropdown-item text-danger" data-bs-toggle="modal"
                                    data-bs-target="#modal-staff-lg" id="button-peruubahan-data-user" data-code="{{ $datas->email }}">
...
<script>
    $(document).on("click", "#button-add-user-cabang", function(e) {
        e.preventDefault();
        $('#menu-staff-lg').html(
    ...
    $(document).on("click", "#button-peruubahan-data-user", function(e) {
        e.preventDefault();
        ...
        $.ajax({
            url: "{{ route('master_user_cabang_reset_password') }}",
            type: "POST",
            cache: false,
            data: {
                "_token": "{{ csrf_token() }}",
