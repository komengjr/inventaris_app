<div class="modal-body p-0">
    <div class="bg-warning rounded-top-lg py-3 ps-4 pe-4">
        <h4 class="mb-1" id="staticBackdropLabel">Update Data Master Barang</h4>
        <p class="fs--2 mb-0">Support by <a class="link-600 fw-semi-bold" href="#!">Transforma</a></p>
    </div>
    <form class="row g-3 p-4" id="form-edit-not-found" action="#" method="post" enctype="multipart/form-data">
        @csrf
        <div class="col-md-6">
        ...
        <div class="col-12">
            <span id="loading-button-edit">
                <button class="btn btn-primary float-end" type="button" id="button-save-not-found"><span
