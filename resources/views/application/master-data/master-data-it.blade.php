        ...
        <div class="card bg-100 shadow-none border">
            <div class="row gx-0 flex-between-center">
                <div class="col-sm-auto d-flex align-items-center border-bottom">
                    <img class="ms-3 mx-3" src="{{ asset('img/user-akses.png') }}" alt="" width="50" />
                    <div>
                ...
                <div class="col-xl-auto px-3 py-2">
                    ...
                    <h4 class="text-primary fw-bold mb-0">Master <span class="text-info fw-medium">Data IT</span>
                    </h4>
                </div>
            </div>
        </div>
...
<div class="card mb-3">
    <div class="card-header">
        <div class="row align-items-center">
            <div class="col">
                <h5 class="mb-0">Master Barang IT</h5>
            </div>
            <div class="col-auto">
                <div class="btn-group" role="group">
                    ...
                    <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop2">
                        ...
                        <button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#modal-staff-lg"
                            id="button-add-barang-cabang"><span class="fas fa-user-lock"></span>
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group" role="group">
                            ...
                            <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop2">
                                <button class="dropdown-item text-danger" id="button-remove-data-barang" data-code="{{ $datas->inventaris_data_it_code }}">
...
<script>
    $(document).on("click", "#button-add-barang-cabang", function(e) {
        e.preventDefault();
        $('#menu-staff-lg').html(
            '<div class="spinner-border my-3" style="display: block; margin-left: auto; margin-right: auto;" role="status"><span class="visually-hidden">Loading...</span></div>'
        );
        $.ajax({
            url: "{{ route('master_data_it_add') }}",
            type: "POST",
            cache: false,
            data: {
                "_token": "{{ csrf_token() }}",
    ...
    $(document).on("click", "#button-remove-data-barang", function(e) {
        e.preventDefault();
        ...
        swalWithBootstrapButtons.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: "{{ route('master_data_it_remove') }}",
                    type: "POST",
                    cache: false,
                    data: {
                        "_token": "{{ csrf_token() }}",
