    ...
    @csrf
     <div class="body" id="showdatabarang">
        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-md-9">
                    <label for="inputPassword4" class="form-label">Riwayat Mutasi</label>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <table class="styled-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$datamutasi->kd_mutasi}}</td>
                                <td>{{$datamutasi->asal_mutasi}}</td>
                                <td>{{$datamutasi->target_mutasi}}</td>
                                <td>{{$datamutasi->penanggung_jawab}}</td>
                                <td>{{$datamutasi->penerima}}</td>
                                <td>{{$datamutasi->menyetujui}}</td>
                                <td>{{$datamutasi->yang_menyerahkan}}</td>
