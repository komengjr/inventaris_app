...
<br><br>
<div id="tambahsubdatamutasibarang" class="p-4">
    <a class="btn btn-info btn-sm "
        onclick="window.open('printdokumenmutasi/{{ $data[0]->id_mutasi }}','myActionWin','width=1300,height=800,toolbar=0');"><i
            class="fa fa-print"> Cetak Pengajuan</i></a>
    @if ($data[0]->ket == 1)
        <label class="custom-file-upload pl-3 btn btn-dark btn-sm m-0" id="upload-container">
            <input type="file" id="browseFilex" class="form-control" />
            <i class="fa fa-upload "> Upload Bukti</i>
        </label>
    @elseif($data[0]->ket == 2)
        <label class="custom-file-upload pl-3 btn btn-dark btn-sm m-0" id="upload-container">
            <input type="file" id="browseFilex" class="form-control" />
            <i class="fa fa-upload "> Upload Ulang</i>
        </label>
    @endif
