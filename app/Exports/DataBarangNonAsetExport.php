...
class DataBarangNonAsetExport implements FromQuery, WithHeadings, ShouldAutoSize
{
    ...
    public function query()
    {
        ...
        )->where('inventaris_data_cabang', Auth::user()->cabang)->where('inventaris_data_jenis',0)->orderBy('id_inventaris_data' , 'ASC');
    }
