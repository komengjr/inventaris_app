                                ...
                                for (
                                    a.contains(i) || (i = null),
                                        e._isSingleParent() && n + 1 === s
                                            ? (h.removeLayer(e),
                                              e._recursivelyAddChildrenToMap(
                                                  null,
                                                  s,
                                                  a
                                              ))
            ...
            this._recursively(t, n, i, function (e) {
                e._recursivelyAnimateChildrenIn(
                    ...
                    e._isSingleParent() && r - 1 === n
                        ? (e.clusterShow(),
                          e._recursivelyRemoveChildrenFromMap(t, i, r))
                        : e.clusterHide(),
                    e._addToMap();
            });
        },
            ...
            _noanimationUnspiderfy: function () {
                ...
                for (
                    ...
                    (e = s[t]),
                        ...
                        e._spiderLeg &&
                            (r.removeLayer(e._spiderLeg), delete e._spiderLeg);
